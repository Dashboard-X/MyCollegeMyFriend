<%@ Page Language="C#" MasterPageFile="~/MasterPages/DefaultMasterPage.master" AutoEventWireup="true"
    CodeFile="AddCollegeImage.aspx.cs" Inherits="College_AddCollegeImage" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table border="0" cellpadding="2" cellspacing="2" width="98%" align="center" style="border: solid 1px #00AEEF;">
        ...
        <tr style="background-color: White; height: 25px;">
            <td>
                ...
                &nbsp;&nbsp;
                <asp:Label ID="LabelJoinMessage1" runat="server" SkinID="lblGreenText" Text=" Upolad College Images !"
                    Font-Bold="true" Font-Size="12pt"></asp:Label>
            </td>
        </tr>
        <tr>
    ...
    <table border="0" cellpadding="2" cellspacing="2" width="98%" align="center" style="border: solid 1px #00AEEF;">
        <tr>
            <td>
                <asp:Label ID="Label1" runat="server" SkinID="lblRedText" Text="Welcome Add Course To College"
                    Font-Bold="true" Font-Size="12pt"></asp:Label>
            </td>
        </tr>
        <tr>
            <td>
                ...
                <asp:Button ID="ButtonAddCourse" runat="server" Text="Add Course" OnClick="ButtonAddCourse_Click" />
            </td>
        </tr>
        <tr>
            <td>
                <asp:DataList ID="CourseList" runat="server">
                </asp:DataList>
            </td>
        </tr>
        <tr>
