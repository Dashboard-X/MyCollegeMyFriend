<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RecentMembers.ascx.cs"
    Inherits="Controls_RecentMembers" %>
<table border="0" cellpadding="2" cellspacing="2" width="100%" align="center" style="border: solid 1px #00AEEF;">
    <tr>
        <td align="left">
            &nbsp;
            <asp:Label ID="labelMembers" runat="server" Text="Members" ForeColor="Green"
                Font-Bold="true" Font-Size="14pt"></asp:Label>
        </td>
    </tr>
    <tr>
        <td align="left" valign="top">
            <asp:DataList ID="RecentUserList" runat="server" RepeatColumns="6" Width="100%">
                <ItemTemplate>
